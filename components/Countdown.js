    ...
    <>
      {countdown &&
        <div className="countdown-section mt-5 pt-5"
          ...
          >
          <h5 className="title-bold text-center">Menghitung Hari</h5>
          <div className="col-10 mx-auto mt-4">
            <div className='row'>
              <div className='col p-1'>
                <div className='card border-0 shadow-sm p-2'>
                  <h5 className='title'>{ countdown.days }</h5>
                  <h6 className='subtitle'>Hari</h6>
                </div>
              </div>
              <div className='col p-1'>
                <div className='card border-0 shadow-sm p-2'>
                  <h5 className='title'>{ countdown.hours }</h5>
                  <h6 className='subtitle'>Jam</h6>
                </div>
              </div>
              <div className='col p-1'>
                <div className='card border-0 shadow-sm p-2'>
                  <h5 className='title'>{ countdown.minutes }</h5>
                  <h6 className='subtitle'>Minit</h6>
                </div>
              </div>
              <div className='col p-1'>
                <div className='card border-0 shadow-sm p-2'>
                  <h5 className='title'>{ countdown.seconds }</h5>
                  <h6 className='subtitle'>Saat</h6>
                </div>
              </div>
            </div>
          </div>
